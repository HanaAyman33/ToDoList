...
public class TDList extends AppCompatActivity {
    ...
    private StringRequest createAuthenticatedRequest(int method, String url,
        ...
        if (accessToken == null) {
            ...
            Toast.makeText(this, "Authentication required. Please login.", Toast.LENGTH_SHORT).show();
            ...
            StringRequest deleteRequest = new StringRequest(Request.Method.PUT, url,
                    response -> {
                        ...
                        try {
                            ...
                            if (status.equals("success")) {
                                tasksContainer.removeView(taskView); // Remove from UI
                                Toast.makeText(this, "Task removed", LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(this, message, LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
